...
class GameState(): 
    '''
    Holds a state of Tic Tac Toe. Board is represented as 
    a 3x3 numpy array. Player is represented as 1 or -1.
    '''
    ...
    def simulate_action(self):
        '''
        Heuristic based action selection. Blocks and takes clear wins.  
        '''
        def check_line(line):
